...
@AnalyzeClasses(packagesOf = JhipsterSampleApplication01App.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterSampleApplication01App.class), alwaysTrue())
